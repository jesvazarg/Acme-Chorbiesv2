...
public class ChorbiTest extends AbstractTest {
	...
	//Registrar editar el perfil de un chorbi
	@Test
	public void driverEditChorbi() {
		final Object testingData[][] = {
			{
				"chorbi10", "chorbi10", "chorbi10", "Pepe", "Botella", "pepe@gmail.com", "1234", "http://web.com/imagen.jpg", "soy yo", "Love", "01/01/1990", "Man", "Lepe", "España", "Andalucia", "Huelva", null
			},
			{
				"chorbi11", "chorbi11", "chorbi11", "Sancho", "Panza", "sancho@gmail.com", "2345", "http://web.com/imagen.jpg", "eres tu", "Friendship", "25/12/1969", "Man", "Cuenca", null, null, null, null
			},
			{
				"chorbi12", "chorbi12", "chorbi12", "Juana", "La Loca", "juana@gmail.com", "3456", "http://web.com/imagen.jpg", "es él", "Love", "15/05/1974", "Woman", "Salamanca", null, null, null, null
			},
			{
				"chorbi13", "chorbi13", "chrb", "Stewie", "Grifin", "stewie@gmail.com", "4567", "http://web.com/imagen.jpg", "es ella", "Friendship", "02/03/1992", "Woman", "Santander", "España", null, null, IllegalArgumentException.class
			},
			{
				"chorbi15", "chorbi15", "chorbi15", "Paquito", "Chocolatero", "paquito.com", "6789", "http://web.com/imagen.jpg", "sois vosotros", "Friendship", "06/06/2011", "Man", "Dos Hermanas", null, "Andalucia", "Sevilla",
				IllegalArgumentException.class
			}, {
				"chorbi14", "chorbi14", "chorbi14", "", "Simpson", "bart@gmail.com", "5678", "http://web.com/imagen.jpg", "somos nosotros", "Love", "14/02/1965", "Man", "San Fernando", null, null, "Cádiz", ConstraintViolationException.class
			}
		};

		for (int i = 0; i < testingData.length; i++)
			this.editChorbi((String) testingData[i][0], (String) testingData[i][1], (String) testingData[i][2], (String) testingData[i][3], (String) testingData[i][4], (String) testingData[i][5], (String) testingData[i][6], (String) testingData[i][7],
				(String) testingData[i][8], (String) testingData[i][9], (String) testingData[i][10], (String) testingData[i][11], (String) testingData[i][12], (String) testingData[i][13], (String) testingData[i][14], (String) testingData[i][15],
				(Class<?>) testingData[i][16]);
	}

	protected void editChorbi(final String username, final String password, final String confirmPassword, final String name, final String surname, final String email, final String phone, final String picture, final String description,
		final String relationship, final String birthDate, final String genre, final String city, final String country, final String state, final String province, final Class<?> expected) {
